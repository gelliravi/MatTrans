...
The MATPOWER (<http://www.pserc.cornell.edu/matpower/>) coding design principles have been inspired to develop the MATTRANS, which however uses MATPOWER package to execute the steady-state power flow.
